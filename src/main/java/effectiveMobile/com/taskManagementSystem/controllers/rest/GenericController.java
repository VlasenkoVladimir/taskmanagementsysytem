...
import effectiveMobile.com.taskManagementSystem.exception.TMSDeleteException;
...
public abstract class GenericController<E extends GenericModel, D extends GenericDto> {
	...
	public void deleteHard(@PathVariable(value = "id") Long id) throws TMSDeleteException {
		service.delete(id);
	}
}